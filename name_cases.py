...
#use a variable to represent a person's name and then print the name in lowercase, uppercase, and title case
...
# use a variable to represent a person's name and include some whitespace characters at the beginning and end. 
...
# assign the value python_notes.txt to a variable called file_name then remove the suffix
